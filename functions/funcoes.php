...
function menu_superior(){
    echo"
    <div id='menusup'>
        <img id='menusup' src='imagens\logo_icon.png' alt='imagem logo pexinxa'>
        <img id='menusup2' src='imagens\logotipo.png' alt='imagem logotipo pexinxa '>
...
function footer(){
    ...
    <div class='logo_footer'>
        <img id='logo_footer' src='imagens\logotipo.png' alt='Logo'><p>Criado por: equipe Pexinxa</p>
        </div>
        <div class='social'>
